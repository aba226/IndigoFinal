...
public class ModlCli {
    ...
    public ModlCli(String firstName, String lastName) {
...
//////////////////////////////////////////////////////////
    ...
    public static ObservableList<ModlCli> getEmployeeList(ResultSet rs) throws SQLException, ClassNotFoundException {
        //Declare a observable List which comprises of Employee objects
        ObservableList<ModlCli> empList = FXCollections.observableArrayList();
 
        while (rs.next()) {
           ModlCli emp = new ModlCli();
